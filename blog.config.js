...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2fb8d8502b468176a354f0a0750bea63',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ruby的博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wo.bobogo.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Ruby, 博客', // 网站关键词 英文逗号隔开
