const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://wo.bobogo.top' },
    { title: '访问文档中心获取更多帮助', url: 'https://bobogo.shop' }
  ],
  ...
  HEO_INFO_CARD_URL2: 'https://wo.bobogo.top',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://bobogo.shop',
